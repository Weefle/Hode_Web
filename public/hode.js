...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = '../public/hode.data';
      var REMOTE_PACKAGE_BASE = 'hode.data';
  ...
  Module['FS_createPath']("/", "res", true, true);
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_../public/hode.data');

      };
      Module['addRunDependency']('datafile_../public/hode.data');
   ...
   loadPackage({"files": [{"filename": "/res/Dark_hod.lvl", "start": 0, "end": 724992, "audio": 0}, {"filename": "/res/Dark_hod.mst", "start": 724992, "end": 735232, "audio": 0}, {"filename": "/res/Dark_hod.sss", "start": 735232, "end": 4026368, "audio": 0}, {"filename": "/res/Fort_hod.lvl", "start": 4026368, "end": 7577600, "audio": 0}, {"filename": "/res/Fort_hod.mst", "start": 7577600, "end": 7618560, "audio": 0}, {"filename": "/res/Fort_hod.sss", "start": 7618560, "end": 10749952, "audio": 0}, {"filename": "/res/Hode.ini", "start": 10749952, "end": 10750751, "audio": 0}, {"filename": "/res/Isld_hod.lvl", "start": 10750751, "end": 15008543, "audio": 0}, {"filename": "/res/Isld_hod.mst", "start": 15008543, "end": 15096607, "audio": 0}, {"filename": "/res/Isld_hod.sss", "start": 15096607, "end": 20570911, "audio": 0}, {"filename": "/res/Lar1_hod.lvl", "start": 20570911, "end": 24470303, "audio": 0}, {"filename": "/res/Lar1_hod.mst", "start": 24470303, "end": 24621855, "audio": 0}, {"filename": "/res/Lar1_hod.sss", "start": 24621855, "end": 31327007, "audio": 0}, {"filename": "/res/Lar2_hod.lvl", "start": 31327007, "end": 33700639, "audio": 0}, {"filename": "/res/Lar2_hod.mst", "start": 33700639, "end": 33805087, "audio": 0}, {"filename": "/res/Lar2_hod.sss", "start": 33805087, "end": 39166751, "audio": 0}, {"filename": "/res/Lava_hod.lvl", "start": 39166751, "end": 41775903, "audio": 0}, {"filename": "/res/Lava_hod.mst", "start": 41775903, "end": 41861919, "audio": 0}, {"filename": "/res/Lava_hod.sss", "start": 41861919, "end": 46215967, "audio": 0}, {"filename": "/res/Pwr1_hod.lvl", "start": 46215967, "end": 51450655, "audio": 0}, {"filename": "/res/Pwr1_hod.mst", "start": 51450655, "end": 51581727, "audio": 0}, {"filename": "/res/Pwr1_hod.sss", "start": 51581727, "end": 58499871, "audio": 0}, {"filename": "/res/Pwr2_hod.lvl", "start": 58499871, "end": 60701471, "audio": 0}, {"filename": "/res/Pwr2_hod.mst", "start": 60701471, "end": 60779295, "audio": 0}, {"filename": "/res/Pwr2_hod.sss", "start": 60779295, "end": 65680159, "audio": 0}, {"filename": "/res/Rock_hod.lvl", "start": 65680159, "end": 70679327, "audio": 0}, {"filename": "/res/Rock_hod.mst", "start": 70679327, "end": 70757151, "audio": 0}, {"filename": "/res/Rock_hod.sss", "start": 70757151, "end": 76317471, "audio": 0}, {"filename": "/res/Setup.cfg", "start": 76317471, "end": 76317683, "audio": 0}, {"filename": "/res/Setup.dat", "start": 76317683, "end": 82152435, "audio": 0}], "remote_package_size": 82152435, "package_uuid": "9b834daa-87f1-45d7-96b3-fe7ec8c7b21b"});
...
var ASM_CONSTS = {
  88316: function($0) {var str = UTF8ToString($0) + '\n\n' + 'Abort/Retry/Ignore/AlwaysIgnore? [ariA] :'; var reply = window.prompt(str, "i"); if (reply === null) { reply = "i"; } return allocate(intArrayFromString(reply), 'i8', ALLOC_NORMAL);},  
 88541: function($0, $1) {alert(UTF8ToString($0) + "\n\n" + UTF8ToString($1));},  
 88598: function($0, $1, $2) {var w = $0; var h = $1; var pixels = $2; if (!Module['SDL2']) Module['SDL2'] = {}; var SDL2 = Module['SDL2']; if (SDL2.ctxCanvas !== Module['canvas']) { SDL2.ctx = Module['createContext'](Module['canvas'], false, true); SDL2.ctxCanvas = Module['canvas']; } if (SDL2.w !== w || SDL2.h !== h || SDL2.imageCtx !== SDL2.ctx) { SDL2.image = SDL2.ctx.createImageData(w, h); SDL2.w = w; SDL2.h = h; SDL2.imageCtx = SDL2.ctx; } var data = SDL2.image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = 0xff; src++; dst += 4; } } else { if (SDL2.data32Data !== data) { SDL2.data32 = new Int32Array(data.buffer); SDL2.data8 = new Uint8Array(data.buffer); } var data32 = SDL2.data32; num = data32.length; data32.set(HEAP32.subarray(src, src + num)); var data8 = SDL2.data8; var i = 3; var j = i + 4*num; if (num % 8 == 0) { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; } } else { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; } } } SDL2.ctx.putImageData(SDL2.image, 0, 0); return 0;},  
 90053: function($0, $1, $2, $3, $4) {var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf;},  
 91042: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 91135: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 91204: function() {return screen.width;},  
 91229: function() {return screen.height;},  
 91255: function() {return window.innerWidth;},  
 91285: function() {return window.innerHeight;},  
 91316: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 91411: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 91548: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
 91772: function($0) {if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } if (SDL2.audioContext) { autoResumeAudioContext(SDL2.audioContext); } } return SDL2.audioContext === undefined ? -1 : 0;},  
 92265: function() {var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate;},  
